...
def getTimeEvolutionGlobal(stress='strain', nx='nx=3^6x2'):
  ...
  data = h5py.File(path(key=key, nx=nx, stress=stress, fname='data_sync-t_global.hdf5'), 'r')
...
def getTimeEvolutionPlastic(stress='strain', nx='nx=3^6x2'):
  ...
  data = h5py.File(path(key=key, nx=nx, stress=stress, fname='data_sync-t_plastic.hdf5'), 'r')
