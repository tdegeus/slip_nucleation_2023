...
for nx in list_nx():
  ...
  for delta in list_delta():
    ...
    elif delta == 'stress=1d6': offset = 0.15490721596789805
    elif delta == 'stress=2d6': offset = 0.15490721596789805
    elif delta == 'stress=3d6': offset = 0.15490721596789805
    elif delta == 'stress=4d6': offset = 0.15490721596789805
    elif delta == 'stress=5d6': offset = 0.15490721596789805
    elif delta == 'stress=6d6': offset = 0.15490721596789805
